...
are also available for past versions of jclouds are also available in the [Release Notes archive](/releasenotes/).
...
Please see the [test results](/releasenotes/1.5-tests) for jclouds Version 1.5.
